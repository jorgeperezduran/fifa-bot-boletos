...
var axiosHelper_1 = require("../../../helpers/axiosHelper");
var cheerio = require('cheerio');
var request = new axiosHelper_1.ApiHelper();
function searchTickets() {
    return __awaiter(this, void 0, void 0, function () {
        var contentResponseRegular, contentResponsResale, found, $2, $3, polandRegular, polandResale, polandResponse, polandResponse, argentinaRegular, argentinaResale, argentinaResponse, polandResponse, arabiaRegular, arabiaResale, argentinaResponse, polandResponse, sound;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request.get('https://fcfs-intl.fwc22.tickets.fifa.com/secure/selection/event/date/product/101397570845/lang/en', {
                        headers: {
                ...
                case 1:
                    contentResponseRegular = _a.sent();
                    return [4 /*yield*/, request.get('https://resale-intl.fwc22.tickets.fifa.com/secure/selection/event/date/product/101397570845/lang/en', {
                            headers: {
                ...
                case 2:
                    contentResponsResale = _a.sent();
                    found = 0;
                    $2 = cheerio.load(contentResponseRegular.data);
                    $3 = cheerio.load(contentResponsResale.data);
                    polandRegular = $2("#101437163861").toString();
                    polandResale = $3("#101437163861").toString();
                    console.log("Time: ", new Date().toLocaleString());
                    console.log('---RESALE STATUS---', contentResponsResale.status);
                    if (!(contentResponsResale.status != 202)) return [3 /*break*/, 23];
                    if (!polandRegular.includes("sold_out")) return [3 /*break*/, 3];
                    console.log('POLAND REGULAR NOT AVAILABLE');
                    return [3 /*break*/, 5];
                case 3:
                    found = found + 1;
                    console.log('yes!!!! POLAND REGULAR AVAILABLE');
                    return [4 /*yield*/, request.get('https://api.telegram.org/bot5508181787:AAGSNq5vR1LmZ67nQUuT1mwHyNFTZnMeXBU/sendMessage?chat_id=-658435217&text=Boletos+Mexico+VS+Polonia+Regular+Disponibles+https://fcfs-intl.fwc22.tickets.fifa.com/secure/selection/event/seat/performance/101437163861/lang/en')];
                case 4:
                    polandResponse = _a.sent();
                    _a.label = 5;
                case 5:
                    if (!polandResale.includes("sold_out")) return [3 /*break*/, 6];
                    console.log('POLAND RESALE NOT AVAILABLE');
                    return [3 /*break*/, 8];
                case 6:
                    found = found + 1;
                    console.log('yes!!!! POLAND RESALE AVAILABLE');
                    return [4 /*yield*/, request.get('https://api.telegram.org/bot5508181787:AAGSNq5vR1LmZ67nQUuT1mwHyNFTZnMeXBU/sendMessage?chat_id=-658435217&text=Boletos+Mexico+VS+Polonia+Reventa+Disponibles+https://resale-intl.fwc22.tickets.fifa.com/secure/selection/resale/item?performanceId=101437163861&lang=en')];
                case 7:
                    polandResponse = _a.sent();
                    _a.label = 8;
                case 8:
                    argentinaRegular = $2("#101437163878").toString();
                    argentinaResale = $3("#101437163878").toString();
                    if (!argentinaRegular.includes("sold_out")) return [3 /*break*/, 9];
                    console.log('ARGENTINA REGULAR NOT AVAILABLE');
                    return [3 /*break*/, 11];
                case 9:
                    found = found + 1;
                    console.log('yes!!!! ARGENTINA REGULAR AVAILABLE');
                    return [4 /*yield*/, request.get('https://api.telegram.org/bot5508181787:AAGSNq5vR1LmZ67nQUuT1mwHyNFTZnMeXBU/sendMessage?chat_id=-658435217&text=Boletos+Mexico+VS+ARGENTINA+Regular+Disponibles+https://fcfs-intl.fwc22.tickets.fifa.com/secure/selection/event/seat/performance/101437163878/lang/en')];
                case 10:
                    argentinaResponse = _a.sent();
                    _a.label = 11;
                case 11:
                    if (!argentinaResale.includes("sold_out")) return [3 /*break*/, 12];
                    console.log('ARGENTINA RESALE NOT AVAILABLE');
                    return [3 /*break*/, 14];
                case 12:
                    found = found + 1;
                    console.log('yes!!!! ARGENTINA RESALE AVAILABLE');
                    return [4 /*yield*/, request.get('https://api.telegram.org/bot5508181787:AAGSNq5vR1LmZ67nQUuT1mwHyNFTZnMeXBU/sendMessage?chat_id=-658435217&text=Boletos+Mexico+VS+Argentina+Reventa+Disponibles+https://resale-intl.fwc22.tickets.fifa.com/secure/selection/resale/item?performanceId=101437163878&lang=en')];
                case 13:
                    polandResponse = _a.sent();
                    _a.label = 14;
                case 14:
                    arabiaRegular = $2("#101437163894").toString();
                    arabiaResale = $3("#101437163894").toString();
                    if (!arabiaRegular.includes("sold_out")) return [3 /*break*/, 15];
                    console.log('SAUDI ARABIA REGULAR NOT AVAILABLE');
                    return [3 /*break*/, 17];
                case 15:
                    found = found + 1;
                    console.log('yes!!!! SAUDI ARABIA REGULAR AVAILABLE');
                    return [4 /*yield*/, request.get('https://api.telegram.org/bot5508181787:AAGSNq5vR1LmZ67nQUuT1mwHyNFTZnMeXBU/sendMessage?chat_id=-658435217&text=Boletos+Mexico+VS+Arabia+Regular+Disponibles+https://fcfs-intl.fwc22.tickets.fifa.com/secure/selection/event/seat/performance/101437163894/lang/en')];
                case 16:
                    argentinaResponse = _a.sent();
                    _a.label = 17;
                case 17:
                    if (!arabiaResale.includes("sold_out")) return [3 /*break*/, 18];
                    console.log('ARABIA RESALE NOT AVAILABLE');
                    return [3 /*break*/, 20];
                case 18:
                    found = found + 1;
                    console.log('yes!!!! ARABIA RESALE AVAILABLE');
                    return [4 /*yield*/, request.get('https://api.telegram.org/bot5508181787:AAGSNq5vR1LmZ67nQUuT1mwHyNFTZnMeXBU/sendMessage?chat_id=-658435217&text=Boletos+Mexico+VS+Arabia+Reventa+Disponibles+https://resale-intl.fwc22.tickets.fifa.com/secure/selection/resale/item?performanceId=101437163894&lang=en')];
                case 19:
                    polandResponse = _a.sent();
                    _a.label = 20;
                case 20:
                    if (!(found > 0)) return [3 /*break*/, 22];
                    sound = require("sound-play");
                    return [4 /*yield*/, sound.play(__dirname.concat('/sample-3s.mp3'))];
                case 21:
                    _a.sent();
                    _a.label = 22;
                case 22:
